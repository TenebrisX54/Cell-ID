...
1. Click the green button or the link above to open the release page.
2. On the page, find the latest version listed.
3. Under the assets section, look for a `.exe` file. This is the installer.
4. Click the `.exe` file to download it to your computer.
5. Make sure to remember where you saved the file.

---

## 💻 Installing Cell-ID on Windows

Once the download completes, follow these instructions:

1. Locate the downloaded `.exe` file in your Downloads folder or the location you chose.
...
6. When done, you will see a confirmation screen. Click "Finish."

The app will now be ready to run.

---

## ▶️ Running Cell-ID for the First Time

1. Find the Cell-ID shortcut on your desktop or search for it in the Start menu.
2. Double-click to open the program.
3. Connect your compatible device to your PC if you are using external hardware.
4. The app will detect your device automatically.
5. You can now start viewing your mobile network’s signal details.

---

## 🔍 Understanding What Cell-ID Shows You
...
## 📡 Using Cell-ID to Improve Your Network
...
2. Run the installer and overwrite the old version.
